	...
	<div id="mainLayout">
		...
		<div class="ad_home_wrap">
			...
			<div class="good_common_show">
				<div class="good_com_box">
					<div class="box_picture">
						<img alt="符号公社 男士字母时尚休闲卫衣" height="350px;" width="300px;"
							src="images/homesingleshow/TB1Ue5hQFXXXXX4apXXXXXXXXXX_!!0-item_pic.jpg_400x400.jpg">
					</div>
					<p></p>
					<div class="box_shadow"></div>
					<div id="shadoWord">
						<a id="chaKanXiangQing" href="page/detail/detail.jsp">查看详情</a> <a
							id="kuaiJieTuiJian" href="buycart.action?">加入购物车</a>
					</div>
				</div>
				<div class="good_com_box">
					<div class="box_picture">
						<img alt="符号公社 男士字母时尚休闲卫衣" height="350px;" width="300px;"
							src="images/homesingleshow/TB1wqJ4PVXXXXb4aXXXXXXXXXXX_!!0-item_pic.jpg_430x430q90.jpg">
					</div>
					<p></p>
					<div class="box_shadow"></div>
					<div id="shadoWord">
						<a id="chaKanXiangQing" href="page/detail/detail.jsp">查看详情</a> <a
							id="kuaiJieTuiJian">加入购物车</a>
					</div>
				</div>
				<div class="good_com_box">
					<div class="box_picture">
						<img alt="符号公社 男士字母时尚休闲卫衣" height="350px;" width="300px;"
							src="images/homesingleshow/TB2uoALhMxlpuFjy0FoXXa.lXXa_!!1944046363.jpg_430x430q90.jpg">
					</div>
					<p></p>
					<div class="box_shadow"></div>
					<div id="shadoWord">
				...
				<div class="good_com_box">
					<div class="box_picture">
						<img alt="符号公社 男士字母时尚休闲卫衣" height="350px;" width="300px;"
							src="images/homesingleshow/TB1KkWHQVXXXXcTXFXXXXXXXXXX_!!0-item_pic.jpg_430x430q90.jpg">
					</div>
					<p></p>
					<div class="box_shadow"></div>
					<div id="shadoWord">
			...
			<div class="good_common_show">
				...
				<div class="good_com_box">
					<div class="box_picture">
						<img height="350px;" width="300px;"
							src="images/homesingleshow/yingyang/TB2gdHUmHBnpuFjSZFGXXX51pXa_!!2939922051.jpg_430x430q90.jpg"></img>
					</div>
					<p></p>
					<div class="box_shadow"></div>
					<div id="shadoWord">
				...
				<div class="good_com_box">
					<div class="box_picture">
						<img height="350px;" width="300px;"
							src="images/homesingleshow/yingyang/TB2KS_JqpXXXXboXpXXXXXXXXXX_!!793880721.jpg_430x430q90.jpg"></img>
					</div>
					<p></p>
					<div class="box_shadow"></div>
					<div id="shadoWord">
				...
				<div class="good_com_box">
					<div class="box_picture">
						<img height="350px;" width="300px;"
							src="images/homesingleshow/yingyang/TB2YQu_mxdkpuFjy0FbXXaNnpXa_!!910933581.jpg"></img>
					</div>
					<p></p>
					<div class="box_shadow"></div>
					<div id="shadoWord">
				...
				<div class="good_com_box">
					<div class="box_picture">
						<img height="350px;" width="300px;"
							src="images/homesingleshow/yingyang/TB1sYhpQFXXXXXzaXXXXXXXXXXX_!!0-item_pic.jpg_430x430q90.jpg"></img>
					</div>
					<p></p>
					<div class="box_shadow"></div>
					<div id="shadoWord">
			...
			<!-- 								<a class="fb-touch" href="#"></a> <a class="tweet-touch" -->
			<!-- 									href="#"></a> <a class="linkedin-touch" href="#"></a> -->
			<!-- 							</div> -->
			<!-- 						</div> -->
			<!-- 					</div> -->
			<!-- 					<div class="single-member effect-3"> -->
