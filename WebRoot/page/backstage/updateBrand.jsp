			...
			<table id="upBrtable">
				...
				<tr>
					<td class="upBrFont"><s:textfield cssClass="upBrtextfield"
							name="brandAD.brName" label="中文名称" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="upBrFont"><s:textfield cssClass="upBrtextfield"
							name="brandAD.brEngName" label="英文名称" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td class="upBrFont"><s:textarea id="upBrText"
							name="brandAD.brDiscription" label="简介" /></td>
				</tr>
				<tr>
					<td><label>所属店铺:</label>
					</td>
